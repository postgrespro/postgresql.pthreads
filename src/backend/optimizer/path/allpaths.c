...
session_local bool		enable_geqo = false;	/* just in case GUC doesn't set it */
session_local int			geqo_threshold;
session_local int			min_parallel_table_scan_size;
session_local int			min_parallel_index_scan_size;
