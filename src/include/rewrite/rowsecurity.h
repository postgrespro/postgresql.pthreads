...
extern session_local PGDLLIMPORT row_security_policy_hook_type row_security_policy_hook_permissive;

extern session_local PGDLLIMPORT row_security_policy_hook_type row_security_policy_hook_restrictive;
