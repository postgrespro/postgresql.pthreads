...
extern session_local PGDLLIMPORT RepOriginId replorigin_session_origin;
extern session_local PGDLLIMPORT XLogRecPtr replorigin_session_origin_lsn;
extern session_local PGDLLIMPORT TimestampTz replorigin_session_origin_timestamp;
