...
extern session_local int	vacuum_defer_cleanup_age;
extern session_local int	max_standby_archive_delay;
extern session_local int	max_standby_streaming_delay;
