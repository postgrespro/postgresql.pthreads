 ...
 * GUC variables
 */
extern session_local int	max_predicate_locks_per_xact;
extern session_local int	max_predicate_locks_per_relation;
extern session_local int	max_predicate_locks_per_page;
