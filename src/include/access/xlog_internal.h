 ...
 */
extern session_local bool ArchiveRecoveryRequested;
extern session_local bool InArchiveRecovery;
extern session_local bool StandbyMode;
extern session_local char *recoveryRestoreCommand;
