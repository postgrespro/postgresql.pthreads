 ...
 * allpaths.c
 */
extern session_local bool enable_geqo;
extern session_local int	geqo_threshold;
extern session_local int	min_parallel_table_scan_size;
extern session_local int	min_parallel_index_scan_size;
...
typedef void (*set_rel_pathlist_hook_type) (PlannerInfo *root,
											...
											Index rti,
											RangeTblEntry *rte);
extern session_local PGDLLIMPORT set_rel_pathlist_hook_type set_rel_pathlist_hook;
...
extern session_local PGDLLIMPORT set_join_pathlist_hook_type set_join_pathlist_hook;

/* Hook for plugins to replace standard_join_search() */
typedef RelOptInfo *(*join_search_hook_type) (PlannerInfo *root,
											  int levels_needed,
											  List *initial_rels);
extern session_local PGDLLIMPORT join_search_hook_type join_search_hook;
